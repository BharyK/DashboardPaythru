        ...
        <div className="container-fluid" >
            <div className="row flex-nowrap" >
                <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0" >
                    <div className="d-flex flex-column align-items-start align-items-sm-start text-white" style={{ minHeight: "100vh", background: "#f8f9fa" }}>
                            ...
                            {navigationList.map((label, index) => {
                                return (
                                    <li className={index === isActive ? 'activeClass' : "nav-item"} key={label.id} onClick={() => handleActiveClass(label.id)}>
                                        <NavLink to={label.to} className='nav-link align-middle px-0'>
