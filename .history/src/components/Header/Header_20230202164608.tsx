...
const Header = () => {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
            <a className="navbar-brand"><img src = {logo} alt = "logo" width = "150px" height = "20px"/></a>
            ...
            <div className={show ? "collapse navbar-collapse justify-content-end align-items-center" : ''} id="navbarText">
                <ul className="navbar-nav  d-flex justify-content-end">
                    <li className="nav-item active mt-2 ">
                        ...
                        <p className = "last-login-text">Last Login:01-Feb.23 14:49:05 <span><i className="bi bi-person-fill text-warning" style = {{fontSize: "12px"}}></i></span></p>
                    </li>
                </ul>
            </div>
